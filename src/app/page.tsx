...
import { ArrowRight, Trophy, Users, Star, BarChart2, Zap, Shield, Menu, X, Award, Calendar, Info, Gift, Facebook, Github } from 'lucide-react'
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex justify-center mb-4">
            <a 
              ...
              className="text-gray-400 hover:text-blue-400 transition-colors text-base sm:text-lg flex items-center space-x-2 bg-gray-800/50 hover:bg-gray-800 px-5 py-3 rounded-lg"
            >
            ...
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="flex items-center justify-center md:justify-end mt-4 md:mt-0 space-x-2">
                <p className="text-gray-500 text-xs sm:text-sm text-center md:text-right">
                  Powered by Hithium • Made with ❤️ for BUET football community by
                </p>
                              <a 
              ...
              >
                <svg className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
